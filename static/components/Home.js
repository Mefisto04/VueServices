...
//   <div class="row">
//     <div class="col-lg-3" v-for="(freelancer, j) in freelancerList" :key="freelancer.id" v-if="freelancer.is_approved">
//       <div class="card shadow-sm mb-3" style="border-radius: 10px;">
//         <div class="card-body text-center">
  ...
  <hr/>
      ...
      <div class="row mb-4">
        ...
        <div class="col-md-4">
          ...
          <input type="number" v-model="selectedRating" @input="filterFreelancers" class="form-control" min="0" max="10" placeholder="Rating 0-10"/>
        </div>
      </div>
